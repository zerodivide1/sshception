...
TUNNEL_CONNECTION_STRING="$TUNNEL_CONNECTION_STRING -p $TUNNEL_PORT"


TARGET_CONNECTION_STRING=
if [ -z "$TARGET_USERNAME" ] ; then
  TARGET_CONNECTION_STRING="$TARGET_HOST"
else
  TARGET_CONNECTION_STRING="$TARGET_USERNAME@$TARGET_HOST"
fi

TARGET_CONNECTION_STRING="$TARGET_CONNECTION_STRING -p $TARGET_PORT"
